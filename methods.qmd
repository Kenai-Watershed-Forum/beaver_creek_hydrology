...
<<<<<<< HEAD
All water temperature logger sites were visited in Spring / Summer 2023, and log files were downloaded from each logger. The process QA/QC described from Fall 2022 was applied in an identical fashion.
=======
All water temperature logger sites were revisited in Spring / Summer 2023, and log files were downloaded from each logger. The process QA/QC described from Fall 2022 was applied in an identical fashion. QA/QC files are available in the project's GitHub repository.
...
# join post-QA/QC dataframes from fall 2022 and summer 2023 downloads
allData <- bind_rows(allData_fall22,allData_summer23) %>%
  # remove redundant data
  distinct()

# remove old dataframes
rm(allData_fall22,allData_summer23)

```
>>>>>>> 8dbd9ecc5a3273bb001ea3ce53eb5ae02bf26e3b
...
[NOTE: the long-term KWF logger site, also labeled "beaver_creek_usgs_temp_3" in this download, has a pair of twin loggers at one location.]
