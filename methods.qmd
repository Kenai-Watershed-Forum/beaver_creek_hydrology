...
All water temperature logger sites were visited in Spring / Summer 2023, and log files acquired from each logger. The process QA/QC described from Fall 2022 was applied in an identical fashion.
