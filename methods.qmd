...
Logger sites that were not downloaded in Fall 2023 include TL-1, TL-3, and TL-11. These sites will be visited by th end of October 2023 if weather conditions allow.
...
##logger <-21235341
##logger <-21235343
#logger <-21444843    ## csv not present 10/11/2023
##logger <-21444844
#logger <-21444869    ## csv not present 10/11/2023
##logger <-21444870
##logger <-21444872
##logger <-21444873
##logger <-21444874
##logger <-21488145   ## csv not present 10/11/2023
