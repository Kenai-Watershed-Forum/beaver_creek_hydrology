...
Our project includes water temperature data from a total of fifteen locations throughout the Beaver Creek watershed. In summer 2022 we established thirteen sites to monitor water temperature with HOBO TempPro v2 loggers, in addition to the one site previously established by Kenai Watershed Forum. The USGS Alaska Science Center also established a real-time gauging station in the lower reach, which records water temperature in addition to discharge. These data (station \# 15266500) are available online at <https://waterdata.usgs.gov/monitoring-location/15266500/>.
